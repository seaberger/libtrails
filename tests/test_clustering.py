...
class TestClusterTopics:
    ...
    def test_cluster_returns_stats_cooccurrence_mode(
        self, mock_build_graph, mock_leidenalg, mock_update_cluster
    ):
    ...
    @patch("libtrails.clustering.leidenalg")
    @patch("libtrails.topic_graph.build_topic_graph_cooccurrence_only")
    def test_cluster_with_partition_types(
        self, mock_build_graph, mock_leidenalg, mock_update_cluster
    ):
    ...
    @patch("libtrails.clustering.leidenalg")
    @patch("libtrails.topic_graph.build_topic_graph_cooccurrence_only")
    def test_cluster_with_custom_cooccurrence_min(
        self, mock_build_graph, mock_leidenalg, mock_update_cluster
    ):
